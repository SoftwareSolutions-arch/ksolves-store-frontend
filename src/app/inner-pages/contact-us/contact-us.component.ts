  ...
  getMyaccountDetails() {
    ...
    if(login=='true'){
      this.service.getAllData('my/home').subscribe(res => {
        this.myDetails=res.data.your_details
        this.addShopFormGroup.controls.name.setValue(this.myDetails.name);
        this.addShopFormGroup.controls.email.setValue(this.myDetails.email);
      })
    }
  }
