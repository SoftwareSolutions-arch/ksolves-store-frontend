...
export class FestivalComponent implements OnInit {
  ...
  constructor(public service: ServicesService, public title: Title
    ...
    this.step=(localStorage.getItem('tabNo')==null)?this.step:localStorage.getItem('tabNo')
  ...
  setCategoriesHighLight(val: any) {
    localStorage.setItem('tabNo',val)
